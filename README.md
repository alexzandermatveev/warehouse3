...
Веб-приложение для моделирования и визуализации планов размещения товаров на складе (решение задачи SLAP — Storage Location Assignment Problem).
...
Если в конфигурации не задано множество товаров и ячеек - их также можно сгенерировать в конструкторе [(рис. 1)](#fig1).

<a id="fig1"></a>
![warehouse_constructor](pictures/warehouse_constructor.png)<br>
...
- $p_{\text{distance}}$ – расстояние от ячейки до точки консолидации (Манхэттенское),
- $k$ – весовой коэффициент для учета относительного уровня (в зависимости от весогабаритных свойств груза, уровень
...
предпочтительным оказывается ярус. Далее значения волнообразно распределяются по соседним ярусам, увеличиваясь на 1 по мере удаления от наиболее удобного уровня [(рис. 2)](#fig2).

<a id="fig2"></a>
<img src="pictures/relative_levels_of_convenience.png" width="500"><br>
...
составлено по одному плану размещения для каждого выбранного алгоритма.

<a id="fig3"></a>
![distribution_methods](pictures/distribution_methods.png)<br>
*Рис. 3 – Методы распределения на стороне клиента*

### Визуализация

После получения сформированных планов размещения - их можно скачать в виде JSON-файла. Также сервис формирует на странице
